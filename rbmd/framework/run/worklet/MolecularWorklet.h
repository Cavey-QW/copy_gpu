...
struct NewConstraintAWaterBondAngleWorklet : vtkm::worklet::WorkletMapField
{
                            ...
                            const ExecPointLocator& locator) const
  {
    ...
    //printf("1输出结果为：%f, %f, %f \n %f, %f, %f \n ", whole_pts.Get(i0)[0], whole_pts.Get(i0)[1], whole_pts.Get(i0)[2], whole_velocity.Get(i0)[0], whole_velocity.Get(i0)[1], whole_velocity.Get(i0)[2]);
