...
namespace RunWorklet
{
    ...
    {
      ComputeNearForceRBLERFWorklet(const Id& rs_num, const Id& pice_num, const Real& qqr2e,const Vec3f& box )
        : _rs_num(rs_num)
        , _pice_num(pice_num)
        , _qqr2e(qqr2e)
        , _box(box)
    ...
    struct ComputeNewRBEForceWorklet : vtkm ::worklet::WorkletMapField
       {
                                   ...
                                   Vec3f& force) const
         {
           ...
           for (int i = 0; i < _P; i++)
           {
             ...
             auto f = force_function.ComputeRBEForceSum(kl, current_pts, current_charge, rhok_ri);
             //if (atoms_id==10)
             //{
                   ...
                   vtkm::cont::ArrayHandle<Vec3f>& eam_force)
    {
                                ...
                                vtkm::cont::ArrayHandle<Vec3f>& corr_force)
     {
      ...
      void NearForceRBLERFSpecialBonds(const Id& rs_num,
                                       ...
                                       vtkm::cont::ArrayHandle<Vec3f>& corr_force)
     {
       vtkm::cont::Invoker{}(ComputeNearForceRBLERFSpecialBondsWorklet{ rs_num, pice_num, qqr2e ,box},
                             atoms_id,
                             locator,
                             topology,
                             force_function,
