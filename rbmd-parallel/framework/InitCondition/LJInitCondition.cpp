...
void LJInitCondition::SetParameters()
{
  ...
  std::array<double, 3> bBoxMin = { _x_range[0], _y_range[0], _z_range[0] };
  std::array<double, 3> bBoxMax = { _x_range[1], _y_range[1], _z_range[1] };
  _para.SetParameter(PARA_BOXMIN, bBoxMin);
  _para.SetParameter(PARA_BOXMAX, bBoxMax);
